...
################################
## Priority class
priority_classes = {'interrupting':1, 'positive':2, 'negative':99}
## Note: Hierarchical classes are defined in the jupyter notebook and passed here via hier_classes_dict
################################
## Short functions
################################
...
class patient (object):
    ...
    def __init__ (self, index, diseaseGroups, fractionED, arrivalRate, last_patient_time, hier_classes_dict):
        ...
        self._hier_classes_dict = hier_classes_dict
    ...
    def hier_class (self):
        ...
        if not self.is_positive: 
            ...
            # For all AIs that flagged the patient positive, get the corresponding disease number. Return the smallest number (highest priority) from this list. 
            all_flagged_pclasses = [self._hier_classes_dict[ii]['disease_num'] for ii in self._is_positives.keys()]

            return min(numpy.array(all_flagged_pclasses))
